  ...
  setup() {
    ...
    useHead({
      ...
      meta: [
        {
          name: 'description',
          content: 'Verwalten Sie Ihre Liegenschaften effizient mit Remsfal. Erfahren Sie mehr über unsere neuesten Angebote und Funktionen.'
        },
        {
          property: 'og:title',
          content: 'Remsfal – Effizientes Liegenschaftsmanagement online'
        },
        {
    ...
    <div class="widget-column">
      ...
      <div class="widget">
        <svg fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
             width="40px" height="40px" viewBox="0 0 482.312 482.312"
             xml:space="preserve">
      <g> <g> <g>
