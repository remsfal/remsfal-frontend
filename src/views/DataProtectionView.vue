...
12345 Berlin
      ...
      <h3>Anmeldung und Registrierung Mit Google</h3>
      <p>
        Auf dieser Webseite können Sie sich mit Google registrieren. Um diesen
        Dienst zu nutzen, müssen sie Ihre Google E-Mail Adresse und Ihr Passwort
        eingeben. Google wird diese Daten an unsere Webseite weitergeben,
        wodurch wir Sie identifizieren können.
      </p>
      <p>
        Wenn Sie diese Möglichkeit nutzen, besteht für uns die Möglichkeit, auf
        Ihre bei Google gespeicherten Daten zuzugreifen. Diese Zugriffsrechte
        können Sie jederzeit in Ihrem Google-Konto widerrufen. Die Einstellungen
        dafür finden Sie unter https://myaccount.google.com/permissions und
        https://myaccount.google.com/security.
      </p>
      <p>
        Die Datenverarbeitung auf Grundlage der von Google bereitgestellten
        Informationen dient einem möglichst einfachen Registrierungsprozess
        (Artikel 6, Abs. 1 DSGVO). Die Daten werden ausschließlich für die
        Registrierung und Anmeldung verwendet und nicht an Dritte weitergegeben.
      </p>
