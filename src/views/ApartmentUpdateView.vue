...
const handleSubmit = async (formData: any) => {
  ...
  if (formData) {
    ...
    livingSpace.value = formData.livingSpace !== undefined ? formData.livingSpace : livingSpace.value;
    usableSpace.value = formData.usableSpace !== undefined ? formData.usableSpace : usableSpace.value;
    heatingSpace.value = formData.heatingSpace !== undefined ? formData.heatingSpace : heatingSpace.value;
  }
        ...
        <template #content>
          <div class="p-fluid formgrid grid grid-cols-12 gap-4">
            <div class="input-container col-span-12">
              <label class="label" for="title">{{ t('apartment.title') }} <span class="required-field">*</span></label>
            ...
            <div class="input-container col-span-6">
              <label class="label" for="livingSpace">{{ t('apartment.livingSpace') }} <span class="required-field">*</span></label>
              <InputText id="livingSpace" v-model="livingSpace" type="number" :class="{ 'p-invalid': errors.livingSpace }" />
              <small v-if="errors.livingSpace" class="p-error">{{ errors.livingSpace }}</small>
            </div>

            <div class="input-container col-span-6">
              <label class="label" for="usableSpace">{{ t('apartment.usableSpace') }} <span class="required-field">*</span></label>
              <InputText id="usableSpace" v-model="usableSpace" type="number" :class="{ 'p-invalid': errors.usableSpace }" />
              <small v-if="errors.usableSpace" class="p-error">{{ errors.usableSpace }}</small>
            </div>

            <div class="input-container col-span-6">
              <label class="label" for="heatingSpace">{{ t('apartment.heatingSpace') }} <span class="required-field">*</span></label>
              <InputText id="heatingSpace" v-model="heatingSpace" type="number" :class="{ 'p-invalid': errors.heatingSpace }" />
