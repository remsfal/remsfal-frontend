...
export default class ApartmentService {
  ...
  async createApartment(projectId: string, buildingId: string, data: ApartmentJson): Promise<ApartmentJson> {
  ...
  async getApartment(projectId: string, apartmentId: string): Promise<ApartmentJson> {
  ...
  // Update an apartment
  async updateApartment(projectId: string, apartmentId: string, data: ApartmentJson): Promise<ApartmentJson> {
