...
async function onSubmit(event: FormSubmitEvent) {
  ...
  try {
    ...
    toast.add({
      ...
      detail: t('apartment.saveSuccess'),
      life: 3000,
    });
  } catch (err) {
      ...
      >
        <div class="flex flex-col gap-6">
          ...
          <div class="flex flex-col gap-1">
            <label for="title" class="font-medium">{{ t('apartment.title') }}*</label>
            <InputText
              id="title"
              name="title"
              fluid
          ...
          <!-- Lage/Standort -->
          <div class="flex flex-col gap-1">
            <label for="location" class="font-medium">{{ t('apartment.location') }}</label>
            <InputText
              id="location"
              name="location"
              fluid
          ...
          <!-- Beschreibung -->
          <div class="flex flex-col gap-1">
            <label for="description" class="font-medium">{{ t('apartment.description') }}</label>
            <Textarea
              id="description"
              name="description"
              :rows="3"
