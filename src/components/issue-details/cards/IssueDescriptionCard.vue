<script setup lang="ts">
  ...
  const description = ref([
    "## Issue Description",
    "",
    "Users are experiencing login failures on mobile devices when using the app.",
    "The issue appears to be related to session management.",
    "",
    "### Steps to Reproduce:",
      ...
      <template #content>
        <div v-if="isEditMode" class="flex flex-col gap-2">
          ...
          <span class="text-xs text-gray-500">
            Note: Edit functionality is non-functional (placeholder only)
          </span>
        </div>
