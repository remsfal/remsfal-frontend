    ...
    <Card>
      ...
      <template #content>
        <Tabs v-model:value="activeTab">
            ...
            <div class="flex flex-col gap-4">
              ...
              <div class="flex gap-3 p-3 border rounded">
                ...
                <div class="flex-1">
                  ...
                  <p class="text-sm">
                    I've investigated this issue and it appears to be related to
                    the session token expiration logic. The mobile app is not
                    properly refreshing the token before it expires.
                  </p>
                </div>
              </div>
              ...
              <div class="flex gap-3 p-3 border rounded">
                ...
                <div class="flex-1">
                  ...
                  <p class="text-sm">
                    Thanks for the analysis, Alice. I've assigned this to Jane who
                    can work on the token refresh logic. This is blocking several
                    other issues so let's prioritize it.
                  </p>
                </div>
              </div>
          ...
          <!-- Activity Log Tab -->
          <Tab header="Activity Log" :value="1">
            <div class="flex flex-col gap-3">
              ...
              <div class="flex gap-3 p-3 border-l-4 border-blue-500 bg-blue-50">
                ...
                <div class="flex-1">
                  ...
                  <p class="text-sm">
                    ...
                    to
                    <span class="font-mono bg-yellow-200 px-1 rounded">
                      IN_PROGRESS
                    </span>
                  </p>
                </div>
              ...
              <div class="flex gap-3 p-3 border-l-4 border-purple-500 bg-purple-50">
                ...
                <div class="flex-1">
                  ...
                  <p class="text-sm">
                    <span class="font-medium">Bob Williams</span>
