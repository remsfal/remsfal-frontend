...
import IssueDescription from "../../src/views/IssueDescription.vue";
...
describe("IssueDescription.vue", () => {
  ...
  describe("Textarea Configuration", () => {
    ...
    it("should have 8 rows initially", () => {
      const textarea = wrapper.findComponent(Textarea);
      const nativeTextarea = textarea.find("textarea");

      expect(nativeTextarea.exists()).toBe(true);
      expect(nativeTextarea.attributes("rows")).toBe("8");
    });
    ...
    it("should have correct placeholder text", () => {
      ...
      expect(nativeTextarea.attributes("placeholder")).toBe(
        "Write markdown description here..."
      );
    });
