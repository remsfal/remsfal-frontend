...
export const organizationHandlers = [
  ...
  http.get(`${API_BASE}/organizations/employments`, () => {
    return HttpResponse.json({ employees: [mockEmployee] }, { status: 200 });
  }),
  ...
  // GET /organizations/:organizationId/employees — must come before /:organizationId
  http.get(`${API_BASE}/organizations/:organizationId/employees`, () => {
    return HttpResponse.json({ employees: [mockEmployee] }, { status: 200 });
  }),

  // POST /organizations/:organizationId/employees
  http.post(`${API_BASE}/organizations/:organizationId/employees`, () => {
    return HttpResponse.json({ ...mockEmployee, id: 'emp-new' }, { status: 200 });
  }),
  ...
  http.delete(`${API_BASE}/organizations/:organizationId/employees/:employeeId`, () => {
    return new HttpResponse(null, { status: 204 });
  }),

  // GET /organizations/:organizationId
  http.get(`${API_BASE}/organizations/:organizationId`, ({ params }) => {
    return HttpResponse.json({ ...mockOrganization, id: params.organizationId }, { status: 200 });
  }),
